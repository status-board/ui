...
import { configureStore, getDefaultMiddleware } from './index';
...
describe('configureStore', () => {
    ...
    //             },
    //         };
    //         expect(configureStore({ reducer: mockReducer })).toBeInstanceOf(Object);
    //         expect(redux.combineReducers).toHaveBeenCalledWith(mockReducer);
    //         expect(redux.applyMiddleware).toHaveBeenCalled();
    //         expect(devtools.composeWithDevTools).toHaveBeenCalled();
    //         expect(redux.createStore).toHaveBeenCalledWith(
    //             expect.any(Function),
